...
const
   CasePropError='Обьект с полем <%s> не должен иметь одинаковое, с другими обьектами, значение свойства <Падеж> на одном обьекте-родителе';
   CasePropErrorLabel='Обьект с текстом <%s> не должен иметь одинаковое, с другими обьектами, значение свойства <Падеж> на одном обьекте-родителе';
...
//     MessageBox(Application.Handle,Pchar(Format(CasePropError,[Self.Name])),'Ошибка',MB_ICONERROR);
    end else
     FTypeCase:=Value;
