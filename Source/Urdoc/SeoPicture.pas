...
function TSeoPicture.GetGraphicClass(Header: array of byte): TGraphicClass;
begin
  Result:=nil;
...
procedure TSeoPicture.LoadFromStream(Stream: TMemoryStream);
var
...
procedure TSeoPicture.SaveToStream(Stream: TMemoryStream);
begin
 if Graphic<>nil then
   Graphic.SaveToStream(Stream);
end;

function TSeoPicture.isEmpty: Boolean;
begin
  Result:=(Height=0)and(Width=0);
end;

procedure TSeoPicture.Assign(Source: TPersistent);
begin
  inherited;
end;
