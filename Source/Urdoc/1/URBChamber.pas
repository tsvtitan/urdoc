...
begin
  ...
  if mr=mrYes then begin
    if not deleteRecord then begin
      ShowError(Application.Handle,'Палата <'+Mainqr.FieldByName('name').AsString+'> используется.');
    end;
  end;
end;
...
function TfmBlanks.ChamberNameExists(strName: String; var ID: Integer): Boolean;
var
  qr: TIBQuery;
  sqls: string;
  tr: TIBTransaction;
