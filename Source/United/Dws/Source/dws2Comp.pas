...
//    procedure Call(Caller: TProgram; Func: TFuncSymbol); override;
  ...
  Tdws2CustomInstance = class;

  TInstantiateEvent = procedure(AInstance: Tdws2CustomInstance; var ExtObject: TObject) of object;
...
//    FOnInitialize: TInitializeEvent;
  ...
  protected
    ...
    procedure DoInstantiate(AInstance: Tdws2CustomInstance; var ExternalObject: TObject); virtual;
  ...
  public
    ...
    property Instance: Tdws2CustomInstance read FInstance write FInstance; 
...
begin
  ...
  begin
    ...
    FOnInstantiate(FInstance,extObj);
...
procedure Tdws2CustomInstance.DoInstantiate(AInstance: Tdws2CustomInstance; var ExternalObject: TObject);
begin
  if Assigned(FOnInstantiate) then
    FOnInstantiate(AInstance,ExternalObject);
end;
