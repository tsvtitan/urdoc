...
function GetDiskInfo(Value: TDiskSign; MediaTypes: TMediaTypeSet=[dtFixed, dtRemote, dtRAMDisk]): TDiskInfo;
...
function GetDiskInfo(Value: TDiskSign; MediaTypes: TMediaTypeSet): TDiskInfo;
var
...
begin
  with Result do begin
    ...
    FileFlags:=[];
    if (MediaType in MediaTypes) and
       GetMediaPresent(Value) then begin
