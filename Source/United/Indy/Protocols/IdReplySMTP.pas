...
type
  ...
  public
    ...
    constructor CreateWithReplyTexts( ACollection: TIdCollection; AReplyTexts: TIdReplies ); overload; override; 
...
constructor TIdReplySMTP.CreateWithReplyTexts( ACollection: TIdCollection; AReplyTexts: TIdReplies );
begin
